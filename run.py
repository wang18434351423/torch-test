...
from models.discern import Model   # 模型
from utils.data_load import get_valid_DataLoader, get_train_DataLoader   # 数据集
...
warnings.filterwarnings('ignore')   # 别特么警告我
...
'''获取DataLoader类型的训练数据'''
train_dl = get_valid_DataLoader(Config)
valid_dl = get_train_DataLoader(Config)
